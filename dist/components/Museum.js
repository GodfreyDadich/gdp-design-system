...
var Museum = function Museum(_ref) {
  ...
  return _react2.default.createElement(
    'div',
    {
      ...
      className: 'jsx-2768493088' + ' ' + ('carouselWrapper ' + (caption && caption.length > 0 ? ' withCaption' : '') + (classAdd ? ' ' + classAdd : ''))
    },
    mobile ? _react2.default.createElement(
      ...
      galleries.map(function (gallery, index) {
        return _react2.default.createElement(
          'div',
          { style: mobileStyles, key: 'galleryThumb-' + index, className: 'jsx-2768493088'
          },
      ...
      'div',
      {
        className: 'jsx-2768493088'
      },
      _react2.default.createElement(
        'div',
        {
          className: 'jsx-2768493088' + ' ' + 'museum-container'
        },
        _react2.default.createElement(
          'div',
          {
            className: 'jsx-2768493088' + ' ' + 'expand'
          },
          _react2.default.createElement(
            'span',
            {
              className: 'jsx-2768493088' + ' ' + 'expand-indicator'
            },
        ...
        galleries.map(function (gallery, index) {
          return _react2.default.createElement(
            ...
            { onClick: function onClick(e) {
              ...
              }, style: thumbStyles, key: 'galleryThumb-' + index, className: 'jsx-2768493088' + ' ' + 'grid-image'
            },
            _react2.default.createElement(_Image2.default, {
              aspectRatio: thumbAspect || 'sixteen',
              imgSource: gallery.thumb.length > 0 ? gallery.thumb : gallery.images[0],
        ...
        modalView ? _react2.default.createElement(
          'div',
          {
            ...
            }, className: 'jsx-2768493088' + ' ' + 'modal'
          },
          _react2.default.createElement('div', { onClick: function onClick(e) {
            ...
            }, className: 'jsx-2768493088' + ' ' + 'modalTouchArea'
          }),
    ...
    _react2.default.createElement(_style2.default, {
      styleId: '2768493088',
      css: '.modalOpen.jsx-2768493088{overflow:hidden;}.expand.jsx-2768493088{font-family:Atlas Grotesk;color:#7F7F7F;position:absolute;top:1vw;left:1vw;font-weight:400;font-size:10px;-webkit-letter-spacing:1.25px;-moz-letter-spacing:1.25px;-ms-letter-spacing:1.25px;letter-spacing:1.25px;}.expand.jsx-2768493088::before{content:url("data:image/svg+xml,%3Csvg%20width%3D%2225%22%20height%3D%2225%22%20fill%3D%22none%22%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%3E%3Ccircle%20cx%3D%2212.5%22%20cy%3D%2212.5%22%20r%3D%2211.9%22%20stroke%3D%22%237F7F7F%22%20stroke-width%3D%221.3%22/%3E%3Cpath%20stroke%3D%22%237F7F7F%22%20stroke-width%3D%221.3%22%20d%3D%22M11.6%209.6h6.8v8.8h-6.8z%22/%3E%3Cpath%20d%3D%22M16.5%209.5v-2h-2m-3%209h-2v-2m5-7h-5v7m5-7v-2h-7v9h2%22%20stroke%3D%22%237F7F7F%22%20stroke-width%3D%221.3%22/%3E%3C/svg%3E");}.expand-indicator.jsx-2768493088{margin-left:8px;position:absolute;width:80vw;top:50%;-webkit-transform:translateY(-50%);-ms-transform:translateY(-50%);transform:translateY(-50%);}.museum-container.jsx-2768493088{background:#f2f2f2;padding:6vw;}.grid-image.jsx-2768493088:hover{-webkit-filter:brightness(70%);filter:brightness(70%);}.modal.jsx-2768493088{position:fixed;top:0;left:0;width:100vw;height:100vh;z-index:1000;}.modalTouchArea.jsx-2768493088{cursor:pointer;position:absolute;top:30px;right:30px;width:30px;height:30px;z-index:9999;background-repeat:no-repeat;}'
    })
  );
};
