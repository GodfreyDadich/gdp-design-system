...
var SelectNative = function SelectNative(_ref) {
  ...
  return _react["default"].createElement("div", {
    className: _style["default"].dynamic([["4258161895", [borderColor, borderWidth, borderRadius, selectPadding, selectFont, fontSize, backgroundColor, borderColor, borderColor, selectPadding - 5, fontSize / 2 + selectPadding, borderColor, borderColor, borderColor]]]) + " " + 'select'
  }, _react["default"].createElement("div", {
    className: _style["default"].dynamic([["4258161895", [borderColor, borderWidth, borderRadius, selectPadding, selectFont, fontSize, backgroundColor, borderColor, borderColor, selectPadding - 5, fontSize / 2 + selectPadding, borderColor, borderColor, borderColor]]]) + " " + "select__icon"
  }, _react["default"].createElement("div", {
    className: _style["default"].dynamic([["4258161895", [borderColor, borderWidth, borderRadius, selectPadding, selectFont, fontSize, backgroundColor, borderColor, borderColor, selectPadding - 5, fontSize / 2 + selectPadding, borderColor, borderColor, borderColor]]]) + " " + 'caret'
  }, ">"), _react["default"].createElement("div", {
    className: _style["default"].dynamic([["4258161895", [borderColor, borderWidth, borderRadius, selectPadding, selectFont, fontSize, backgroundColor, borderColor, borderColor, selectPadding - 5, fontSize / 2 + selectPadding, borderColor, borderColor, borderColor]]]) + " " + 'triangle'
  }), _react["default"].createElement("div", {
    className: _style["default"].dynamic([["4258161895", [borderColor, borderWidth, borderRadius, selectPadding, selectFont, fontSize, backgroundColor, borderColor, borderColor, selectPadding - 5, fontSize / 2 + selectPadding, borderColor, borderColor, borderColor]]]) + " " + 'chevron'
  })), _react["default"].createElement("select", {
    disabled: disabled,
    className: _style["default"].dynamic([["4258161895", [borderColor, borderWidth, borderRadius, selectPadding, selectFont, fontSize, backgroundColor, borderColor, borderColor, selectPadding - 5, fontSize / 2 + selectPadding, borderColor, borderColor, borderColor]]]) + " " + 'styledSelect'
  }, options.map(function (option, index) {
    return _react["default"].createElement("option", {
      key: option + index,
      className: _style["default"].dynamic([["4258161895", [borderColor, borderWidth, borderRadius, selectPadding, selectFont, fontSize, backgroundColor, borderColor, borderColor, selectPadding - 5, fontSize / 2 + selectPadding, borderColor, borderColor, borderColor]]])
    }, option);
  })), _react["default"].createElement(_style["default"], {
    id: "4258161895",
    dynamic: [borderColor, borderWidth, borderRadius, selectPadding, selectFont, fontSize, backgroundColor, borderColor, borderColor, selectPadding - 5, fontSize / 2 + selectPadding, borderColor, borderColor, borderColor]
