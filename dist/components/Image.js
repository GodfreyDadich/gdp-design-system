...
var Image = function Image(_ref) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      { linkUrl: linkUrl },
      _react2.default.createElement('img', { alt: imageTitle, src: imgSource, className: _style2.default.dynamic([['109169153', [aspectRatio !== 'noAspect' ? 'url(' + imgSource + ')' : '#f2f2f2', horizontalAlign, verticalAlign]]]) + ' ' + 'wrappedImage'
      })
    ),
