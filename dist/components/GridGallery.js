...
var GridGallery = function GridGallery(_ref) {
  ...
  return _react2.default.createElement(
    'div',
    {
      className: 'jsx-384570827'
    },
    _react2.default.createElement(
      'div',
      {
        className: 'jsx-384570827' + ' ' + 'col-6 skip-3 col-6-tab skip-1-tab'
      },
      headingCaption || ''
    ),
    _react2.default.createElement(
      'div',
      {
        ...
        className: 'jsx-384570827' + ' ' + ('' + (caption && caption.length > 0 ? ' withCaption' : '') + (classAdd ? ' ' + classAdd : ''))
      },
      ...
      _react2.default.createElement(
        ...
        images.map(function (image, index) {
          return _react2.default.createElement(
            'div',
            { style: mobileStyles, key: escape(image) + '-' + index, className: 'jsx-384570827'
            },
      ...
      _react2.default.createElement(
        'div',
        {
          className: 'jsx-384570827' + ' ' + 'mobile-flat'
        },
        _react2.default.createElement(
          'div',
          {
            className: 'jsx-384570827' + ' ' + 'mobile-grid-container'
          },
          _react2.default.createElement(
            'div',
            { style: evenGridStyles, className: 'jsx-384570827'
            },
            _react2.default.createElement(_Image2.default, {
      ...
      _react2.default.createElement(
        ...
        altAsset.map(function (alt, index) {
          return _react2.default.createElement(
            'div',
            { style: mobileStyles, key: escape(alt) + '-' + index, className: 'jsx-384570827'
            },
            _react2.default.createElement(_Image2.default, {
              aspectRatio: thumbAspect,
              imgSource: alt,
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          {
            className: 'jsx-384570827' + ' ' + 'grid-container'
          },
          _react2.default.createElement(
            'div',
            {
              className: 'jsx-384570827' + ' ' + 'image-wrapper'
            },
            carousel === 'yes' ? _react2.default.createElement(
              'div',
              {
                className: 'jsx-384570827' + ' ' + 'expand'
              },
              _react2.default.createElement(
                'span',
                {
                  className: 'jsx-384570827' + ' ' + 'expand-indicator'
                },
              ...
              return _react2.default.createElement(
                ...
                function (_ref2) {
                  ...
                  return _react2.default.createElement('img', {
                    ...
                    src: isVisible ? image : '',
                    className: 'jsx-384570827' + ' ' + 'moasic-image'
                  });
                }
              );
            }),
            modalView ? _react2.default.createElement(
              'div',
              {
                ...
                }, className: 'jsx-384570827' + ' ' + 'modal'
              },
              _react2.default.createElement('div', { onClick: closeGallery, className: 'jsx-384570827' + ' ' + 'modalTouchArea'
              }),
              'style=',
              {
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          {
            className: 'jsx-384570827' + ' ' + 'columns-grid-container'
          },
          carousel === 'yes' ? _react2.default.createElement(
            'div',
            {
          ...
          thumbs.map(function (image, index) {
            return _react2.default.createElement(
              ...
              { onClick: function onClick(e) {
                ...
                }, style: evenGridStyles, key: 'galleryThumb-' + index, className: 'jsx-384570827' + ' ' + ('' + (carousel === 'yes' ? 'grid-image' : ''))
              },
              _react2.default.createElement(_Image2.default, {
                aspectRatio: thumbAspect || 'noAspect',
                imgSource: image,
    ...
    _react2.default.createElement(_style2.default, {
      styleId: '384570827',
      css: '.modalOpen.jsx-384570827{overflow:hidden;}.moasic-image.jsx-384570827{display:inline-block;position:relative;height:9.4vw;width:auto;}.image-wrapper.jsx-384570827{margin:auto;width:80vw;}@media only screen and (max-width:1025px){.image-wrapper.jsx-384570827{width:60vw;}}.expand.jsx-384570827{font-family:Atlas Grotesk;color:#7F7F7F;position:absolute;top:1vw;left:1vw;font-weight:400;font-size:10px;-webkit-letter-spacing:1.25px;-moz-letter-spacing:1.25px;-ms-letter-spacing:1.25px;letter-spacing:1.25px;}.expand.jsx-384570827::before{content:url("data:image/svg+xml,%3Csvg%20width%3D%2225%22%20height%3D%2225%22%20fill%3D%22none%22%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%3E%3Ccircle%20cx%3D%2212.5%22%20cy%3D%2212.5%22%20r%3D%2211.9%22%20stroke%3D%22%237F7F7F%22%20stroke-width%3D%221.3%22/%3E%3Cpath%20d%3D%22M18%207v5-5zM13%207h5-5zM7%2018v-5%205zM12%2018H7h5z%22%20stroke%3D%22%237F7F7F%22%20stroke-width%3D%221.3%22%20stroke-linecap%3D%22square%22%20stroke-linejoin%3D%22round%22/%3E%3Cpath%20d%3D%22M7%2018L18%207%207%2018z%22%20stroke%3D%22%237F7F7F%22%20stroke-width%3D%221.3%22/%3E%3C/svg%3E");}.expand-indicator.jsx-384570827{margin-left:8px;position:absolute;width:40vw;top:50%;-webkit-transform:translateY(-50%);-ms-transform:translateY(-50%);transform:translateY(-50%);}.grid-container.jsx-384570827{background:#f2f2f2;display:block;position:relative;padding:6vw;}.columns-grid-container.jsx-384570827{background:#f2f2f2;-webkit-flex-direction:row;-ms-flex-direction:row;flex-direction:row;-webkit-flex-wrap:wrap;-ms-flex-wrap:wrap;flex-wrap:wrap;display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;padding:5vw;}.mobile-grid-container.jsx-384570827{background:#f2f2f2;-webkit-flex-direction:row;-ms-flex-direction:row;flex-direction:row;-webkit-flex-wrap:wrap;-ms-flex-wrap:wrap;flex-wrap:wrap;display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;padding:15px;}.grid-image.jsx-384570827:hover{-webkit-filter:brightness(70%);filter:brightness(70%);}.modal.jsx-384570827{position:fixed;top:0;left:0;width:100vw;height:100vh;z-index:1000;}.modalTouchArea.jsx-384570827{cursor:pointer;position:absolute;top:30px;right:30px;width:30px;height:30px;z-index:9999;background-repeat:no-repeat;}'
    })
  );
};
