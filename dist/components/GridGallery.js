  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      mobile ? appliedImages.length > 1 ? _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'mobile-grid-container', style: removeGrayBackground ? { background: 'transparent' } : { background: 'rgb(242,242,242)' } },
          _react2.default.createElement(
            'div',
        ...
        _react2.default.createElement(
          'div',
          { className: mixedOr ? 'grid-container' : removeGrayBackground ? 'columns-grid-container-transparent' : 'columns-grid-container', style: removeGrayBackground ? { background: 'transparent' } : { background: 'rgb(242,242,242)' } },
          _react2.default.createElement(
            _ConditionalClass2.default,
