  ...
  (0, _createClass2["default"])(Select, [{
    ...
    value: function render() {
      ...
      return _react["default"].createElement("div", {
        ...
        className: _style["default"].dynamic([["3860907213", [textColor, borderColor, borderWidth, selectPadding, selectFont, backgroundColor, borderRadius, borderColor, selectPadding - 5, fontSize / 2 + selectPadding, selectIcon, borderColor, borderColor, borderColor, textColor, fontSize, selectFont, inputHeight, textColor, fontSize, selectFont, inputHeight + 2 + selectPadding * 2, fontSize, fontSize + 4, calculatedHeight]]]) + " " + "select".concat(expanded ? ' expanded' : '').concat(disabled ? ' disabled' : '')
        ...
        return _react["default"].createElement("li", {
          ...
          key: option + index,
          className: _style["default"].dynamic([["3860907213", [textColor, borderColor, borderWidth, selectPadding, selectFont, backgroundColor, borderRadius, borderColor, selectPadding - 5, fontSize / 2 + selectPadding, selectIcon, borderColor, borderColor, borderColor, textColor, fontSize, selectFont, inputHeight, textColor, fontSize, selectFont, inputHeight + 2 + selectPadding * 2, fontSize, fontSize + 4, calculatedHeight]]]) + " " + "select__option ".concat(cursor === index ? 'active' : '')
        }, option);
