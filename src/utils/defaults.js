...
export const countIndicator = { counter: 'counter', dots: 'dots', none: 'none' }
export const addDropShadow = { yes: 'yes', no: 'no' }
export const viewMode = { lightMode: 'lightMode', darkMode: 'darkMode' }
export const isCarousel = { yes: 'yes', no: 'no' }
