...
const GridGallery = ({ thumbs, images, columns, countIndicator, thumbAspect, containerAspect, carousel, view, caption, fullWidthCaption, removeGrayBackground, mixedOr, altAsset, headingCaption, classAdd }) => {
      ...
      {mobile
        ? appliedImages.length > 1
          ...
          : <div className='mobile-flat'>
            <div className='mobile-grid-container' style={removeGrayBackground ? { background: 'rgb(242,242,242)' } : { background: 'transparent' }}>
            ...
            {caption && caption.length > 0 ? <Caption classAdd={`${fullWidthCaption ? 'col-8 skip-2 col-6-tab skip-1-tab' : 'col-6 skip-2 col-6-tab skip-0-tab' }`}>{caption}</Caption> : ''}
          </div>
        : <div>
          <div className={mixedOr ? 'grid-container' : 'columns-grid-container'} style={removeGrayBackground ? { background: 'transparent' } : { background: 'rgb(242,242,242)' }}>
          ...
          {caption && caption.length > 0 ? <Caption classAdd={`${fullWidthCaption ? 'col-8 skip-2 col-6-tab skip-1-tab' : 'col-6 skip-2 col-6-tab skip-1-tab' }`}>{caption}</Caption> : ''}
        </div>
      }
    </div>
    <style>{`
