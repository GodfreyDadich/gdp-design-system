...
const Loader = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1080 1080" className='loader'>
      ...
      <g clip-path="url(#a)" id='blue-chip'><path d="M743.66,148.4a1.86,1.86,0,0,1,1.9,1.91V668.63a1.86,1.86,0,0,1-1.9,1.9H595.5c-144.18,0-261.06-116.88-261.06-261.06S451.32,148.4,595.5,148.4Z" fill="#0c8f93"/></g>
      <style jsx>{`
        .loader {
          position: relative;
          display: block;
