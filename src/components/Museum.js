...
const Museum = ({ galleries, columns, thumbAspect, containerAspect, view }) => {
  ...
  return isMobile ? <CircularCarousel countIndicator='counter' caption='' imageAspect={thumbAspect} aspectRatio={containerAspect} >
    {
